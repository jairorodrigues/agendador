...
<div id="corpo" class="container-21 clearfix">
    <div class="grid-21 clearfix">
        ...
        <form action="<c:url value="/paciente/${paciente.id}"/>" id="form-paciente" class="formulario clearfix m-bottom20" method="POST">
                    ...
                    <div class="caixa-input clearfix">
                        ...
                        <div class="ipt-wrapper">
                            ...
                            <c:forEach var="convenio" items="${convenios}">
                                <label class="block m-bottom5">
                                    <input type="checkbox" ${paciente.convenios.contains(convenio) ? 'checked="checked"' : ''} name="paciente.convenios[].id" value="${convenio.id}"/>
                                    ${convenio.nome}
                                </label>
                            </c:forEach>
                                <p class="m-top15">
