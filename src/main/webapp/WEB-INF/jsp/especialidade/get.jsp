...
<div id="corpo" class="container-21 clearfix">
    <div class="grid-21 clearfix">
        ...
        <h2 class="titulo-formulario">Atualizar especialidade "${especialidade.nome}"</h2>
        <form action="<c:url value="/especialidade/${especialidade.id}"/>" id="form-especialidade" class="formulario clearfix m-bottom20" method="POST">
            <div class="caixa-formulario clearfix">
                <fieldset class="fieldset-padrao">
                        ...
                        <div class="ipt-wrapper">
                            <select name="especialidade.profissao.id" class="slct">
                                <c:forEach var="profissao" items="${profissoes}">
                                    <option value="${profissao.id}" ${profissao.id eq especialidade.profissao.id ? 'selected="selected"' : ''}>
                                        ${profissao.nome}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="caixa-input clearfix">
                        ...
                        <div class="ipt-wrapper">
                            <input name="especialidade.nome" value="${especialidade.nome}" class="ipt" type="text"/>
                        </div>
                    </div>
                </fieldset>
